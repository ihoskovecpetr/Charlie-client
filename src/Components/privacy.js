...
console.log("PRIVACYY offset; ", offset);
var hourOff = offset/60
console.log("PRIVACYY  HOURS offset; ", hourOff);

console.log(new Date())
var now = new Date()
now.setHours(now.getHours() + hourOff)
console.log(now)
      ...
      <Row id="row-blog-sticker">
        ...
        <Row className="row-about-content">
          ...
          <Col className="col-content"  xs={12} md={12}>
            ...
            <p>Effective date: April 16, 2019</p>


            <p>Charlie ("us", "we", or "our") operates the https://www.charlieparty.club website (the "Service").</p>

            <p>This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service and the choices you have associated with that data. Our Privacy Policy  for Charlie is created with the help of the <a href="https://www.freeprivacypolicy.com/free-privacy-policy-generator.php">Free Privacy Policy Generator</a>.</p>

            <p>We use your data to provide and improve the Service. By using the Service, you agree to the collection and use of information in accordance with this policy. Unless otherwise defined in this Privacy Policy, terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, accessible from https://www.charlieparty.club</p>
            ...
            <p>Charlie uses the collected data for various purposes:</p>    
            <ul>
            ...
            <p>Charlie will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.</p>

            <h2>Disclosure Of Data</h2>

            <h3>Legal Requirements</h3>
            <p>Charlie may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
            <ul>
                <li>To comply with a legal obligation</li>
                <li>To protect and defend the rights or property of Charlie</li>
            ...
            <ul>
                    <li>By email: ihoskovecpetr@gmail.com</li>
                        <li>By visiting this page on our website: https://www.charlieparty.club/about</li>
